...
// --- DATA: MOBILE STRATEGY SPECIFIC ---
const STRATEGY_STANDARDS = [
  { id: "MARKET", title: "Market Fit Analysis", desc: "We validate your app idea against real market data, analyzing competitors, gap opportunities, and audience demand before a single line of code is written." },
  { id: "USER", title: "User Persona Mapping", desc: "Defining exactly who your users are. We create detailed empathy maps and user journeys to ensure the UI solves specific pain points for specific people." },
  { id: "TECH", title: "Tech Stack Selection", desc: "Native vs Cross-Platform? AWS vs Firebase? SQL vs NoSQL? We provide architectural decision matrices to ensure scalability and cost-efficiency." },
  { id: "MONEY", title: "Monetization Strategy", desc: "Designing the revenue model. Whether subscription (SaaS), freemium, or ad-supported, we architect the payment flows and user upgrade paths." }
];

const BENEFITS_DATA = [
  {
    title: "Reduced Failure Risk",
    desc: "70% of apps fail because of no market need. Our discovery phase filters out bad ideas and refines good ones, saving you from building a product nobody wants."
  },
  {
    title: "Accurate Budget Forecasting",
    desc: "By defining every feature and user flow upfront, we provide precise development estimates. No scope creep, no hidden costs, just a clear financial roadmap."
  },
  {
    title: "Faster Development Velocity",
    desc: "Developers code 2x faster when the blueprint is clear. Our technical specifications document removes ambiguity, allowing engineering teams to fly."
  },
  {
    title: "Investor-Ready Artifacts",
    desc: "Walk into VC meetings with more than just an idea. We provide clickable prototypes, architectural diagrams, and a roadmap that proves you mean business."
  },
  {
    title: "Scalability from Day One",
    desc: "We don't just plan for launch; we plan for 1 million users. Our server and database architecture plans ensure your app won't crash when you go viral."
  },
  {
    title: "Feature Prioritization (MVP)",
    desc: "We help you kill 'nice-to-haves' and focus on the 'need-to-haves'. We define a lean Minimum Viable Product (MVP) to get you to market fast and cheap."
  }
];

const WHY_CHOOSE_CN_DATA = [
  { num: "/ 01", title: "Business-First Approach", desc: "We aren't just coders; we are product consultants. We challenge assumptions and suggest pivots that increase the commercial viability of your app." },
  { num: "/ 02", title: "Tech-Agnostic Advice", desc: "We don't push one technology. If Flutter is best, we say Flutter. If Native iOS is needed, we say Native. Your success drives the stack, not our preferences." },
  { num: "/ 03", title: "Interactive Prototypes", desc: "We deliver high-fidelity Figma prototypes that look and feel like a real app. You can test these with real users to validate UX before coding." },
  { num: "/ 04", title: "Data-Driven Roadmaps", desc: "We plan V1, V2, and V3. Our roadmaps allow for data collection in early phases to inform features in later phases." },
  { num: "/ 05", title: "Legacy Migration Plans", desc: "Have an old app? We strategize how to move data and users to a new platform without losing accounts or SEO rankings." },
  { num: "/ 06", title: "Compliance & Security", desc: "We plan for GDPR, HIPAA, and CCPA from the start. Security is not an afterthought; it is baked into the blueprint." }
];
...
const FEEDBACKS: FeedbackItem[] = [
  {
    ...
    role: "Founder",
    company: "YogaConnect",
    quote: "Code Nest didn't just build what I asked for; they told me what I needed. Their strategy pivot saved us $50k in development costs and improved user signups.",
    imgSrc: "/assets/feedback/michael.jpg",
    serviceTag: "Product Strategy",
    hasVideo: true,
  },
  {
    id: 2,
    name: "James T. Kirk",
    role: "CEO",
    company: "Enterprise Logix",
    quote: "The discovery workshop was a game changer. We walked in with a rough idea and walked out with a full clickable prototype and a 6-month roadmap.",
    imgSrc: "/assets/feedback/bohdan.jpg",
    logoSrc: "/assets/feedback/krytter-logo.png",
    serviceTag: "Discovery Phase",
    ctaText: "See Roadmap",
  },
  {
    id: 3,
    ...
    role: "Director",
    company: "FinSave",
    quote: "Choosing the right tech stack was confusing. Code Nest analyzed our needs and recommended a hybrid approach that halved our maintenance costs.",
    imgSrc: "/assets/feedback/dan.jpg",
    serviceTag: "Tech Consulting",
...
const AUDIT_STEPS = [
  {
    ...
    desc: "Intensive sessions with stakeholders to extract vision, business goals, and unique selling points. We define success metrics (KPIs) upfront."
  },
  {
    icon: <LinkIcon size={28} />,
    title: "UX/UI Prototyping",
    desc: "Creating wireframes and high-fidelity interactive prototypes in Figma. We validate navigation flows to ensure user friction is minimized."
  },
  {
    icon: <FileText size={28} />,
    title: "Technical Blueprint",
    desc: "Writing the PRD (Product Requirements Document), database schema, and API contract (Swagger). This is the 'instruction manual' for developers."
  },
  {
    icon: <Headphones size={28} />,
    title: "Go-to-Market Plan",
    desc: "Planning the soft launch, beta testing groups, App Store Optimization (ASO) keywords, and marketing analytics integration."
  }
];

const FAQ_DATA = [
    {
        question: "Do I need a strategy phase or can we just code?",
        answer: "Skipping strategy is the #1 reason apps fail. Coding without a blueprint leads to expensive rewrites. We highly recommend a 2-week Discovery Phase at minimum."
    },
    {
        question: "What is a Minimum Viable Product (MVP)?",
        answer: "An MVP contains only the core features needed to solve the user's primary problem. It allows you to launch quickly, gather feedback, and iterate without spending your whole budget."
    },
    {
        question: "Do you provide technical documentation?",
        answer: "Yes. You receive a full technical architecture document, database relationship diagrams (ERD), and a clickable design prototype."
    },
    {
        question: "Can I use your blueprints to hire another team?",
        answer: "Absolutely. Our strategy work belongs to you. The documents we produce are detailed enough that any competent development team (including us) can execute them."
    },
    {
        question: "How do you validate an idea?",
        answer: "We analyze competitor apps, check search volume trends, conducting user interviews, and sometimes build landing pages to test signup intent before building."
    }
];
...
export default function MobileStrategy() {
  ...
  const [openStandard, setOpenStandard] = useState<string | null>("MARKET");
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection>
        <HeroInner>
          <HeroContent>
            <Breadcrumbs><span className="star">✦</span><Link to="/">Home</Link> / <Link to="/services">Services</Link> / <strong>Mobile Strategy</strong></Breadcrumbs>
            <motion.h1 initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>Mobile Product <br /> Strategy & Planning</motion.h1>
            <ButtonGroup>
              <MainBtn>Discovery Call</MainBtn>
            ...
            <HeroPara>Success begins before code. We help you validate your idea, design the user journey, and define the technical blueprint for market success.</HeroPara>
            <RatingsRow>
              <RatingItem><span className="brand">Results</span><div className="stars">★★★★★ <span className="val">Proven</span></div></RatingItem>
              <RatingItem><span className="brand">Clutch</span><div className="stars">★★★★★ <span className="val">Top Tier</span></div></RatingItem>
              <RatingItem><span className="brand">( MVP Speed )</span><div className="stars">★★★★★ <span className="val">4-8 Weeks</span></div></RatingItem>
            </RatingsRow>
          </HeroContent>
      ...
      <IntroContainer>
        <BadgeWrapper><span className="dot"></span> Discovery Workshop</BadgeWrapper>
        <LayoutGrid>
          <motion.h2 className="audit-heading">Get a roadmap from <br /> idea to profitable <br /> mobile product</motion.h2>
          <RightContentBlock>
            <p>Our strategy workshop de-risks your investment. We identify market fit, competitor weaknesses, and the exact features needed to win early adopters.</p>
            <BlueButtonGroup><BlueTextBtn>Start Workshop Now</BlueTextBtn><BlueIconBtn><svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M7 17L17 7M17 7H7M17 7V17" stroke={COLORS.lime} strokeWidth="2.5" strokeLinecap="round"/></svg></BlueIconBtn></BlueButtonGroup>
          </RightContentBlock>
        </LayoutGrid>
      </IntroContainer>
      ...
      <StandardsContainer>
        <StandardsInner>
            <h2 className="section-title">Strategic Pillars of <br /> Digital Success</h2>
            <AccordionList>
      ...
      {/* --- 4. WHAT TO EXPECT --- */}
      <GridSection>
        <SectionHeader white>Strategy Benefits</SectionHeader>
        <CardsGrid>
          {[
            { id: "01.", title: "Market Fit", desc: "Validation that real users actually want the problem solved." },
            { id: "02.", title: "Low Risk", desc: "Avoid spending $100k+ building the wrong features." },
            { id: "03.", title: "Architecture", desc: "Selecting the right stack (iOS vs Flutter) for long-term scale." },
            { id: "04.", title: "Investor ROI", desc: "Detailed documents that VCs and Angel Investors demand." },
            { id: "05.", title: "UI Clarity", desc: "Clickable prototypes that show exactly how the app flows." },
            { id: "06.", title: "Cost Control", desc: "Detailed specs ensure developer quotes are accurate." }
          ].map((item, i) => (
      ...
      <BlueCardSection>
        <motion.h2
            ...
            viewport={{ once: true }}
        >
          Why choose Code Nest for <br /> product strategy?
        </motion.h2>
        <ChooseCardsGrid>
      ...
      <PageSevenContainer>
        <BannerWrapper>
          <BannerContent>
            ...
            <BannerText>Assess your product idea?</BannerText>
            
            <DownloadBtn>
              Download MVP readiness checklist
      ...
      <Section8>
        ...
        <Container8>
          <HeaderWrapper>
            ...
            <HeaderTitle>From Idea to IPO</HeaderTitle>
            <HeaderDesc>
              See how our strategy workshops launched successful businesses.
            </HeaderDesc>
          </HeaderWrapper>
