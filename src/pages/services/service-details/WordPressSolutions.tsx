...
const WP_STANDARDS = [
  ...
  { id: "SECURITY", title: "OWASP Security Standards", desc: "Encryption and sanitation protocols that protect against the most common web-based vulnerabilities." },
...
const BENEFITS_DATA = [
  {
    ...
    desc: "A custom WordPress build eliminates the bloat of multi-purpose themes. By utilizing code-splitting and asset prioritization, we ensure Lighthouse scores in the high 90s, which is critical for user retention and organic visibility."
  },
  {
    title: "Enhanced security architecture",
    desc: "Most WordPress hacks happen via outdated or bloated plugins. Our engineering-first approach relies on custom functionality and hardened server-side configurations to protect your database from XSS, SQL injections, and brute-force attacks."
  },
  {
    title: "Native editorial experience",
    desc: "We build intuitive, custom Gutenberg blocks specifically for your brand. This means your marketing team can build complex pages in seconds using a 'What You See Is What You Get' interface, without ever touching a line of code."
  },
  {
    title: "Headless and API ready",
    desc: "Our backends are designed for the modern web. Whether you need to sync WP with a CRM or go fully 'Headless' using React/Next.js for the frontend, our architecture provides a scalable API foundation that grows with your needs."
  },
  {
    title: "Reduced technical debt",
    desc: "Spaghetti code kills projects over time. We provide clean, standards-compliant engineering that is easy to update and troubleshoot. This cuts down long-term maintenance costs and allows other developers to jump in without confusion."
  },
  {
    title: "Seamless multi-language reach",
    desc: "Scaling globally requires a robust i18n strategy. We architect our databases for seamless localization and SEO for global markets, ensuring that performance stays lightning-fast across different regional deployments."
  }
];
...
const WHY_CHOOSE_CN_DATA = [
  ...
  { num: "/ 03", title: "WP Tool Adoption", desc: "Our builds utilize modern tech stacks like Roots/Sage or ACF-focused architectures. We deploy continuous integration and deployment pipelines to validate color contrast, logic stability, and performance daily." },
  { num: "/ 04", title: "Performance-prioritized reporting", desc: "We deliver sub-second loading speeds. Our code-level audits pinpoint server-side bottlenecks and asset delivery issues, providing a clear roadmap for dominating Core Web Vital metrics." },
  { num: "/ 05", title: "Trusted across industries", desc: "High-traffic retailers, media sites, and enterprise firms trust Code Nest. They need partners who understand how technical stability correlates directly to customer conversion and global SEO rank." },
...
const AUDIT_STEPS = [
  {
    ...
    desc: "We kick off the audit by mapping your specific business needs against modern WordPress performance and security standards. We identify technical debt, redundant plugins, and hosting bottlenecks, focusing only on what impacts your compliance and growth."
  },
  {
    icon: <LinkIcon size={28} />,
    title: "Deep code inspection",
    desc: "Here comes the assessment phase. We examine every PHP function, database query, and JavaScript asset. We test Gutenberg block rendering, hook reliability, and third-party API integrations to ensure the architecture supports scaling rather than hindering it."
  },
  {
    icon: <FileText size={28} />,
    title: "Detailed reporting",
    desc: "Your Code Nest audit services end in an end-to-end report highlighting issues in plain language. For sites, we pinpoint unoptimized assets that block rendering; for apps, we flag insecure endpoints. It is presented in a scan-to-fix format—no decoding technical jargon."
  },
  {
    icon: <Headphones size={28} />,
    title: "Improvement support",
    desc: "Beyond the initial audit, we offer continuous engineering partnership to keep your digital assets compliant as they evolve. Choose from real-time developer consultations, quarterly code reviews, or full-scale performance monitoring after every major update."
  }
];
...
const FAQ_DATA = [
    {
        ...
        answer: "Our audit is not just a theme check. We analyze the root server configuration, database index efficiency, PHP worker logic, and third-party API latency. We identify specifically what code is slowing you down and providing a roadmap for sub-second performance."
    },
    {
        question: "How is Code Nest different from typical WordPress agencies?",
        answer: "We are software engineers first. We don't just install plugins; we build custom functionality to replace heavy plugins. Our code follows rigorous PSR standards, utilizing Git workflows, automated testing pipelines, and separate staging environments for fail-safe deployments."
    },
    {
        question: "How long does it take to re-platform an existing site?",
        answer: "A standard enterprise migration and re-engineering project typically takes 6 to 12 weeks. This includes data migration, custom Gutenberg block development, SEO structure preservation, and extensive QA testing before the DNS cutover."
    },
    {
        question: "What kind of maintenance does a custom build require?",
        answer: "Less than a template site. Because our code is clean and standardized, technical debt is minimal. We offer retained engineering services for monthly security patches, version updates, and feature additions, ensuring your site remains secure 24/7."
    },
    {
        question: "Can you guarantee Green Core Web Vitals scores?",
        answer: "Yes. Our architecture is specifically designed for Google's CWV metrics. By optimizing the Critical Rendering Path (CRP) and managing asset loads, we consistently deliver 90+ Mobile scores and 99+ Desktop scores."
    }
];
  ...
  return (
    <PageWrapper>
      ...
      <HeroSection>
        <HeroInner>
          <HeroContent>
            <Breadcrumbs><span className="star">✦</span><Link to="/">Home</Link> / <Link to="/services">Services</Link> / <strong>WordPress development</strong></Breadcrumbs>
            <motion.h1 initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>WordPress <br /> development service</motion.h1>
            <ButtonGroup>
            ...
            <HeroPara>Build fast, SEO-ready, and conversion-optimized websites using our custom WordPress frameworks.</HeroPara>
            <RatingsRow>
      ...
      <IntroContainer>
        <BadgeWrapper><span className="dot"></span> WordPress Audit Service</BadgeWrapper>
        <LayoutGrid>
          <motion.h2 className="audit-heading">Get a complete <br /> application or website <br /> WordPress audit to <br /> ensure growth</motion.h2>
          <RightContentBlock>
            <p>Our audit evaluates your codebase against the latest Core Web Vital requirements, identifying bloat. We provide clear fixes to help you dominate your niche.</p>
            <BlueButtonGroup><BlueTextBtn>Assess my website performance now</BlueTextBtn><BlueIconBtn><svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M7 17L17 7M17 7H7M17 7V17" stroke={COLORS.lime} strokeWidth="2.5" strokeLinecap="round"/></svg></BlueIconBtn></BlueButtonGroup>
          </RightContentBlock>
        </LayoutGrid>
      </IntroContainer>
      ...
      <StandardsContainer>
        <StandardsInner>
            <h2 className="section-title">Engineering standards <br /> covered by our WordPress <br /> specialists</h2>
            <AccordionList>
      ...
      <GridSection>
        ...
        <CardsGrid>
          {[
            { id: "01.", title: "Codebase Integrity", desc: "Checking theme quality and logic to prevent long-term technical debt." },
            { id: "02.", title: "Load Performance", desc: "Maximizing LCP and FID metrics to ensure the site feels instant." },
            { id: "03.", title: "Advanced Security", desc: "Custom firewall configurations and vulnerability scanning at the code level." },
            { id: "04.", title: "Ease of Editing", desc: "Backend audits to ensure your marketing team can update text easily." },
            { id: "05.", title: "Native Editor Logic", desc: "Clean Gutenberg blocks that behave natively and stay fast." },
            { id: "06.", title: "Scaling Architecture", desc: "Database optimization ensuring uptime during traffic spikes." }
          ].map((item, i) => (
      ...
      <BenefitsContainer>
        <div className="title-wrapper">
          <motion.h2 
            ...
            viewport={{ once: true }}
          >
            Why choose our engineered <br /> WordPress solutions?
          </motion.h2>
        </div>
      ...
      <BlueCardSection>
        <motion.h2
            ...
            viewport={{ once: true }}
        >
          Why choose Code Nest for your <br /> WordPress development?
        </motion.h2>
        <ChooseCardsGrid>
      ...
      <Section8>
        ...
        <Container8>
          <HeaderWrapper>
            ...
            <HeaderTitle>What our clients say about COAX</HeaderTitle>
            <HeaderDesc>
              In my direct experience, I have found the engineering resources to be
              consistently professional and proficient.
            </HeaderDesc>
          </HeaderWrapper>
        ...
        <PageTenInner>
            <CTABanner10>
                 <BannerContent10>
                    ...
                    <BannerTitle10>
                        Don't risk fines — start <br /> audit today
                    </BannerTitle10>
                    <ConsultBtn>
